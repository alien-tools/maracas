...
public class TestData {
	...
	public static Path compChangesSources = Paths.get("../test-data/comp-changes/old/src/");
	public static Path compChangesClient = Paths.get("../test-data/comp-changes/client/src/");
}
